...
func parseInputConfigFile(filename string) (map[string]string, error){
...
func ReadInputConfigFile( clusterConfigFile string) (ClusterConfig, error){
	...
	tokenMap, ParseErr := parseInputConfigFile(clusterConfigFile)
	if ParseErr != nil {
